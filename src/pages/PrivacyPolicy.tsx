      ...
      <section className='bg-white mt-16'>
        <div className='py-8 px-4 mx-auto max-w-screen-md lg:py-16 lg:px-6 '>
          <div className='mx-auto max-w-screen-sm text-center mb-8 lg:mb-16'>
            ...
            <p className='font-light text-gray-500 lg:mb-16 sm:text-xl'>Last updated March 15, 2024</p>
          </div>
          <div>
            <p className='mb-4'>
              At Three M Tool &amp; Machine, accessible from https://www.three-m.com, one of our main priorities is the
              privacy of our visitors. This Privacy Policy document contains types of information that is collected and
              recorded by Three M Tool &amp; Machine and how we use it.
            </p>
            ...
            <h2 className='font-semibold text-xl mb-4'>Log Files</h2>

            <p className='mb-4'>
              Three M Tool &amp; Machine follows a standard procedure of using log files. These files log visitors when
            ...
            <h2 className='font-semibold text-xl mb-4'>Privacy Policies</h2>

            <p className='mb-4'>
              You may consult this list to find the Privacy Policy for each of the advertising partners of Three M Tool
              &amp; Machine.
            </p>

            <p className='mb-4'>
              Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
              used in their respective advertisements and links that appear on Three M Tool &amp; Machine, which are
            ...
            <p className='mb-4'>
              Note that Three M Tool &amp; Machine has no access to or control over these cookies that are used by
              third-party advertisers.
            </p>

            <h2 className='font-semibold text-xl mb-4'>Third Party Privacy Policies</h2>

            <p className='mb-4'>
              Three M Tool &amp; Machine's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <h2 className='font-semibold text-xl mb-4'>Children's Information</h2>
            ...
            <p className='mb-4'>
              Three M Tool &amp; Machine does not knowingly collect any Personal Identifiable Information from children
            ...
            <h2 className='font-semibold text-xl mb-4'>Online Privacy Policy Only</h2>

            <p className='mb-4'>
              This Privacy Policy applies only to our online activities and is valid for visitors to our website with
              regards to the information that they shared and/or collect in Three M Tool &amp; Machine. This policy is
              not applicable to any information collected offline or via channels other than this website.
            </p>

            <h2 className='font-semibold text-xl mb-4'>Consent</h2>
