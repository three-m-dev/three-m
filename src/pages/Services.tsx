...
const services = [
	{
		...
		imageOne: '/images/operator-at-okuma.jpg',
	...
	},
	{
		...
		imageOne: '/images/yb.jpg',
		imageTwo: '/images/vertical-turning.jpg',
	},
	{
		title: 'Horizontal Turning',
		description: '',
		path: '/services/horizontal-turning',
		imageOne: '/images/haas-tl-lathe.jpg',
		imageTwo: '/images/operator-at-mazak.jpg',
	},
	{
		title: 'Grinding',
		description: '',
		path: '/services/grinding',
		imageOne: '/images/operator-at-grinding-machine.jpg',
		imageTwo: '/images/grinding-ball-arm.jpg',
	},
	{
		title: 'Inspection',
		description: '',
		path: '/services/inspection',
		imageOne: '/images/zeiss.jpg',
		imageTwo: '/images/inspection-gauges.jpg',
	},
	{
		title: 'Bench & Assembly',
		description: '',
		path: '/services/assembly',
		imageOne: '/images/bench-area.jpg',
		imageTwo: '/images/actuators-in-bench.jpg',
	},
];
