  ...
  return (
    <main className='pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white'>
      <div className='flex justify-between px-4 mx-auto max-w-screen-lg'>
        <article className='mx-auto w-full  format format-sm sm:format-base lg:format-lg'>
          ...
          <p className='lead'>
            ...
            It also includes interactive elements such as dropdowns, modals, datepickers.
          </p>
          <p>
          ...
          <p>
            ...
            the most commonly used UI components, such as buttons, navigation bars, cards, form elements, and more which
