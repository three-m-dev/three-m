    ...
    <nav className='bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200 shadow-md'>
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className='flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse'>
          <Link
            to='/contact'
            className='text-white bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center'>
            Contact Us
          </Link>
          <button
