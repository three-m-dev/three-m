          ...
          <div>
            <div className='mb-10'>
              ...
              <p className='text-gray-500'>
                ...
                titanium, and various plastics. If you have a specific material in mind, please contact us to discuss
                its machinability.
              </p>
            </div>
            <div className='mb-10'>
            ...
            <div className='mb-10'>
              ...
              <p className='text-gray-500'>
                Lead times vary based on the complexity of the project and the current workload. However, we strive to
                provide quick turnarounds and will work with you to meet your deadlines. Please contact us for an
                accurate estimate.
              </p>
            </div>
          </div>
          <div>
            ...
            <div className='mb-10'>
              ...
              <p className='text-gray-500'>
                ...
                sign non-disclosure agreements (NDAs) upon request and ensure that your designs and projects are handled
